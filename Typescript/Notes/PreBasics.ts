...
// 8. Now create an index.html file and put boilerplate code inside it and also include the script tag -> <script src="index.ts" async></script>. The parcel bundler will automatically detect this index.ts file and replace it with the index.js file which the bundler will create after transpiling it.
