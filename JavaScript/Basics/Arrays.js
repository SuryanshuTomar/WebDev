...
// console.log(data);
// Accessing whole 'data' array
// console.log(data[0])
// Accessing the first element of the array using index value.
// console.log(data[data.length - 1])
// Accessing the last element of the array using reverse indexing
// console.log(data.length);
// Using array length property which gives the size of the array.
...
// Creating an array of size 7 and Filling the array using fill() method with 6 -
// let arr1 = new Array(7).fill(6);

// Fill Method -
// - Fill Method is used to fill the array with elements programmatically.
// - Syntax - array.fill(data, startIndex, endIndex(excluded))
// - fill() method can also specify from where do we want to start filling and end filling the array.
// example -
// let arr3 = new Array(9);
// console.log(arr3.fill(4, 3, 5));

// Array.from() Method -
// - We are not using this from() method on our array but we are using this from() method on an Array constructor instead.
...
// Example -
// let arr4 = Array.from({ length: 7 }, () => 3);
// console.log(arr4);

// Example -
// let arr5 = Array.from({ length: 9 }, (_, index) => index + 1);
// console.log(arr5);
...
// - Sort Method takes a Callback function which takes current element and the next element as arguments and perform operations on them until everything is according to the condition mentioned in the callback function.
// - Returning 1 or any value greater than 1 means swap the current and next values
// - Returning -1 or any value lesser than -1 means don't swap the current and next values

// Example -
// const arr = [2, 4, -1, 1, 43, 23, 5, -90];
...
// Another Way -
// If current > next, then that means current - next will always be postive and
// If current < next, then that means current - next will always be negative and that's what we want to return.
// So, We can also right the ascending and descending sort in improved manner like -
// arr.sort((cur, next)=> cur - next)
// Ascending
// arr.sort((cur, next)=> next - cur)
// Descending

// Array.prototype.some() method -
// The some() method tests whether at least one element in the array passes the test implemented by the provided function. It returns true if, in the array, it finds an element for which the provided function returns true; otherwise it returns false. It doesn't modify the array.
// Syntax -> array.some(callbackFunction(currentValue, index, arr), thisValue))
...
// Syntax -> array.every(callbackFunction(currentValue, index, arr), thisValue))
...
// Adds AND/OR Removes elements to/from the the array.const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"];
...
//Sol4:
// const deleteMonth = months.splice
...
// ---------------------------------------------------------------------------------------------------------------------
// Method that mutates the original array -
// splice()
// reverse()
...
// Dataconst account1 = {  owner: "Jonas Schmedtmann",  movements: [200, 450, -400, 3000, -650, -130, 70, 1300],  interestRate: 1.2,
// %  pin: 1111,};
const account2 = {
	owner: "Jessica Davis",
...
// EXAMPLE  1 -
// const movementsUSDs = movements.map((movment) => movment * eurToUsd);
// console.log(movements);
// console.log(movementsUSDs);

// const movementsUSDsFor = [];
// for (const iterator of movements) {
//   movementsUSDsFor.push(iterator * eurToUsd);
// }
// console.log(movementsUSDsFor);

// EXAMPLE  2 -
// const depositedMovements = movements.filter((movement) => movement > 0);
// console.log(depositedMovements);

// const withdrawnMovements = movements.filter((movement) => movement < 0);
// console.log(withdrawnMovements);
...
// EXAMPLE  4 -
// Map Filter Reduce Method Chaining - (PIPELINE)
...
// EXAMPLE - 6
// const currentAccount = accounts.find(account => account.owner === "Jessica Davis")
...
// Another Way - Using flatMap()-
// const overallMovement = accounts.flatMap(acc => acc.movements)
