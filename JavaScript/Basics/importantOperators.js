...
// NOTE: The value of number and stringNumber looks similar here. However, the type of number is Number and type of stringNumber is string. Even though the values are same, the type is not the same. Hence a == check returns true, but when checked for value and type, the value is false.

// Example 3:
// console.log(0 == false) //true
// console.log(0 === false) //false

// NOTE: The value of number and stringNumberReason: same value, different type. Type coercion.
...
// QUESTION: When should you use == and when should you use ===?
