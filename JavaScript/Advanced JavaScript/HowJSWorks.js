...
// - tt's important to note that these variables are not copied from one scope to another. Instead, scopes simply look  up in the scope chain until they find a variable that they need
...
// Note:
// - Variables created with "var" will create a property in the window object.(global namespace/global scope/global object).
...
// - Functions that are created normally are global functions. And we can make any function private either by using module patterns or instead we can use object methods/ instance methods
...
// More Details -> https:
//www.udemy.com/course/the-complete-javascript-course/learn/lecture/22648509#announcements
...
// The Notes for Event loop is in HowAsyncJSWorks.js notes.
