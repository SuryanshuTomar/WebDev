...
// 1. Function Definition or Function Statement
// function avg(a, b) {
// 	return (a + b) / 2;
// 	// return statement
// }
...
// createBooking("Boing 737");
// createBooking("Airline 59", undefined, 2);

// ------------------------------------------------------------------------------------------------
// 2. Function Expressions -

// In this functions are declared and defined as variables.
// const average = function (...nums) {
// 	return nums.reduce((sum, num) => (sum = sum + num)) / nums.length;
// };
...
// (function (name) {
//  console.log("Hi " + name);})("DeathSlayer");
...
// 4. We can store functions in variables or properties
// 5. We can also pass functions as arguments to another function which are called CallBack Functions
// 6. We can also return a value as functions.
// 7. We can call methods also on functions like bind() method.

// - Higher Order Functions -
// 1. A higher-order function is a function that recieves a function as arguments or returns a function or do both.
// 2. This can only be possible because of the first-class functions.

// Note -
// 1. First class function is just a feature which a programming language either has or does not have. There are no first-class functions in practice.
// 2. Whereas Higher Order Functions are used in practice which is possible because a programming supports first-class function.
// 3. CallBack functions allows us to implement abstraction in the code.
